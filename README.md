...
cpsb builds packages from *.hb files in the current directory.
...
All of these variables are required, and cpsb will raise an error if they don't exist.
...
Furthermore, cpsb provides the following variables to the shell script:

| Variable Name | Contents | Usage |
| ----------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -- |
| PACKAGE_DIR | Directory used for packaging. | *.clos package generated by cpsb is in tar.zstd format. Please install the package to this directory. Compression and packaging are handled by cpsb. |
